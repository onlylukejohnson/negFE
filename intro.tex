...
distribution arising from this uniform sampling of $Z$. Importantly,
in the impossibility result the adversary knows the entire
description of the chosen distribution (that is, $Z$) but not the
