...
\begin{description}
    \item[$U_{n,k}$] Picking $k$ points from $\zeroone{n}$ without replacement uniformly results in a distribution we will denote $U_{n,k}$. 
...
&\le \cdot 2^{nk(1-2^{-\alpha}(1-h_2(t/n)))+n}\\
 \end{align*}
 Thus, one has that 
