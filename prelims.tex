...
\[
n\left(1-h_2\left(\frac{t}{n}\right)\right)+\frac{\log{n}}{2}+\frac{1}{2} \ge \beta \ge n\left(1-h_2\left(\frac{t}{n}\right)\right).
\]
...
\beta&\ge \log{2^{n\left(1-h_2\left(\frac{t}{n}\right)\right)} -1} \ge n(1-h_2(t/n)).
\end{align*}
\end{proof}
