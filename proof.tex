...
Since we know that $\kappa =\omega(\log n)$. Suppose that $|\advise| = \poly(n)$.   Roughly this is satisfied if 
\begin{align*}
0 &\le (n-\Theta(n) - 2(\gamma+2\log{n}) - nh_2(1/2-t/n) \\
&\le n(1-\Theta(1))-2\gamma - nh_2(1/2-t/n)\\
\gamma &\le \frac{n(1-\Theta(1) - h_2(1/2-t/n))}{2}.\\
\end{align*}
