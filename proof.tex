...
\multirow{2}{*}{$\alpha = \log{{2^n\choose 2^k}}$} & Log size of number of distributions with $2^k$ points.  \\
&Number of distributions in $U_{n,k}$\\
...
$\pcode$ & $\{ X | |X|=2^k \wedge \Hfuzz(U_X) \ge \gamma\}$.
\end{tabular}
