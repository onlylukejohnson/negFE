...
Since we know that $\kappa =\omega(\log n)$. Then as long as $|\advise| = o(k 2^k) = o (n2^n)$ then 
\begin{align*}
...
this means that 
\[
\frac{\gamma}{n} \le \min\left\{(1-h_2(t/n)) - \log{2e}, \frac{(1-2c - h_2(1/2-t/n))}{2}\right\}.
\]
