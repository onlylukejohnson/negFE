...
Suppose that $\sum_{i=1}^k \alpha_i < \alpha$ then $\mathcal{P}$ correctly predicts with probability greater than $2^{-\alpha}$, a contradiction.  Thus, $\expe_{1\le i\le k} \alpha_i \ge \alpha/k$. 
