...
\end{align*}
As long as $\ell = o(k 2^k) = o (n2^n)$ and $\delta < 1/10$ then 
\todo{be more precise with the setting of $\delta$, paying a lot here}
\begin{align*}
0 &\ge -\frac{(n-2k)2^k-\ell-k}{2^k} + 2nh_2(1-t/n) +2\\
 &\ge -(n-2c_2n - 2\gamma) + 2nh_2(1-t/n) +2\\
&\ge -n(1-2c_2)+2\gamma + 2nh_2(1-t/n)+2\\
\gamma &\le \frac{n(1-2c_2 - 2h_2(1-t/n))}{2}-1.\\
\end{align*}
...
\]
suffices to ensure $\tilde{m} = \Theta(\log n)$.
